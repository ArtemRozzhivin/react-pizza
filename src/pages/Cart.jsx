...
import { CartItem, MyButton } from '../components';
import { CartEmpty } from '../pages';
import { setClearCart, setRemovePizzas, setPlusPizza, setMinusPizza } from '../redux/actions/cart';
...
function Cart() {
  ...
  const plusPizza = (id) => {
    dispatch(setPlusPizza(id));
  };

  const minusPizza = (id) => {
    dispatch(setMinusPizza(id));
  };
            ...
            <div className="content__items">
              {addedPizzas.map((obj) => (
                <CartItem
                  ...
                  type={obj.type}
                  size={obj.size}
                  idTotalPrice={items[obj.id].totalPrice}
                  idTotalCount={items[obj.id].items.length}
                  removePizzas={removePizzas}
                  plusPizza={plusPizza}
